	...
	<fieldset class="ui-corner-all">
		...
		<table>
			...
			<tr>
				...
				<g:sortableColumn property="fullname" title="${message(code: 'person.userRealName', default: 'Fullname')}" />

				<g:sortableColumn property="accountExpired" title="${message(code: 'person.accountExpired', default: 'Account Expired')}" />

				<g:sortableColumn property="accountLocked" title="${message(code: 'person.accountLocked', default: 'Account Locked')}" />

...
<div class="span-24">
    ...
    <fieldset class="ui-corner-all">
        <legend><g:message code="specialist.edit"/></legend>
        ...
        <g:form method="post">
            <g:hiddenField name="id" value="${specialistInstance?.id}"/>
            <g:hiddenField name="version" value="${specialistInstance?.version}"/>
            <div class="dialog">
                <table>
                    <tbody>

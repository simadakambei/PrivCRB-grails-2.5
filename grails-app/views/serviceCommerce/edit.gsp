...
<head>
    ...
    <title><g:message code="serviceCommerce.edit"/></title>
</head>
...
<div class="span-24">
    ...
    <fieldset class="ui-corner-all">
        <legend><g:message code="serviceCommerce.edit"/></legend>
        ...
        <g:form method="post">
            ...
            <g:hiddenField name="version" value="${serviceCommerceInstance?.version}"/>
            <div class="dialog">
                <table>
                    <tbody>

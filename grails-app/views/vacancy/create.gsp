...
<head>
    ...
    <title><g:message code="vacancy.create"/></title>
</head>
...
<div class="span-24">
    ...
    <fieldset class="ui-corner-all">
        <legend><g:message code="vacancy.create"/></legend>
            ...
            <div class="dialog">
                <table>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: vacancyInstance, field: 'wageRate', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: vacancyInstance, field: 'salary', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: vacancyInstance, field: 'housing', 'errors')}">

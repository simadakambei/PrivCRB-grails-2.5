...
<head>
    ...
    <title><g:message code="computerAccessoryType.edit"/></title>
</head>
...
<div class="span-24">
    ...
    <fieldset class="ui-corner-all">
        <legend><g:message code="computerAccessoryType.edit"/></legend>
        ...
        <g:form method="post">
            ...
            <g:hiddenField name="version" value="${computerAccessoryTypeInstance?.version}"/>
            <div class="dialog">
                <table>
                    <tbody>

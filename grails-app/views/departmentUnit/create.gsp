...
<head>
    ...
    <title><g:message code="departmentUnit.create"/></title>
</head>
...
<div class="span-24">
    ...
    <fieldset class="ui-corner-all">
        <legend><g:message code="departmentUnit.create"/></legend>
        ...
        <g:form action="save">
            <div class="dialog">
                <table>
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="department"><g:message code="departmentUnit.department"
                        ...
                        <td valign="top"
                            ...
                            <g:select name="department.id" from="${ru.gbuz.ao.privolgie.app.entity.Department.list()}"
                                      optionKey="id" value="${departmentUnitInstance?.department?.id}"
                                      noSelection="['null': '- Выбор подразделения -']"/>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top"
                            ...
                            <g:select name="passportLPU.id" from="${ru.gbuz.ao.privolgie.app.entity.PassportLPU.list()}"
                                      ...
                                      noSelection="['null': '- Выбор паспорта -']"/>

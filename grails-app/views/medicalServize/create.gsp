...
<head>
    ...
    <title><g:message code="medicalServize.create"/></title>
</head>
...
<div class="span-24">
    ...
    <fieldset class="ui-corner-all">
        <legend><g:message code="medicalServize.create"/></legend>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top"
                            ...
                            <g:select name="sectionMedicalCare.id"
                                      ...
                                      value="${sectionMedicalCareInstance?.name?.id}" noSelection="['null': '']"/>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top"
                            ...
                            <g:select name="specialist.id" from="${ru.gbuz.ao.privolgie.app.entity.Specialist.list()}"
                                      optionKey="id" value="${specialistInstance?.name?.id}"
                                      noSelection="['null': '']"/>

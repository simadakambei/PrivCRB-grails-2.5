...
<head>
    ...
    <title><g:message code="LPU.edit"/></title>
</head>
...
<div class="span-24">
    ...
    <fieldset class="ui-corner-all">
        <legend><g:message code="LPU.edit"/></legend>
        ...
        <g:form method="post">
            ...
            <g:hiddenField name="version" value="${LPUInstance?.version}"/>
            <div class="dialog">
                <table>
                    <tbody>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top"
                            class="value ${hasErrors(bean: LPUInstance, field: 'full_title', 'errors')}">
                            <g:textArea name="full_title" rows="3" cols="40"
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: LPUInstance, field: 'site', 'errors')}">
                            <g:textField name="longitude" value="${fieldValue(bean: LPUInstance, field: 'longitude')}"/>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: LPUInstance, field: 'site', 'errors')}">
                            <g:textField name="latitude" value="${fieldValue(bean: LPUInstance, field: 'latitude')}"/>

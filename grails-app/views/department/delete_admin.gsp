...
<head>
    ...
    <title><g:message code="department.delete"/></title>
</head>
...
<fieldset class="ui-corner-all">
    <legend><g:message code="department.choice"/></legend>
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        ...
                        <g:textField name="longitude"
                                     value="${fieldValue(bean: departmentInstance, field: 'longitude')}"/>
                ...
                <tr class="prop">
                    ...
                    <td valign="top"
                        ...
                        <g:textField name="latitude"
                                     value="${fieldValue(bean: departmentInstance, field: 'latitude')}"/>

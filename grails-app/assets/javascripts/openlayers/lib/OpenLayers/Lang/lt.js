...
OpenLayers.Lang['lt'] = OpenLayers.Util.applyDefaults({
    ...
    // console message
    'getFeatureError': "getFeatureFromEvent buvo iškviestas sluoksniui, kuris neturi priskirto paišymo variklio. Tai paprastai nutinka, kai jūs pašalinate sluoksnį, bet paliekate su juo susijusį [handler]",
    ...
    // console message
    'layerAlreadyAdded': "Bandėte pridėti prie žemėlapio sluoksnį ${layerName}, tačiau jis jau yra pridėtas",
